	...
	<script src="jQuery-Validation-Engine-master/js/jquery.validationEngine.js" type="text/javascript" charset="utf-8">
    	...
    	<script>
			jQuery(document).ready(function() {
				...
				jQuery("#frmeditcompany").validationEngine({
...
<div id="pagewrap" class="container" >
  ...
  <li> <a href="main.php"><span class="icon-office"></span>  รายการสถานที่ฝึกงาน</a>
    <ul class="nav">
   		  <li ><a href="managecompany.php"><span ><img src="img/icon/1379637604_Company.png" /></span> จัดการข้อมูลสถานฝึกงาน</a></li>
           <li ><a href="addcompany.php"><span><img src="img/icon/addcom.png" /></span> เพิ่มข้อมูลสถานฝึกงาน</a></li>
      <li class="active"  style="background-color:#d8dfea;"><a href="editcompany.php"><span><img src="img/icon/editcom.png" /></span > แก้ไขข้อมูลสถานฝึกงาน</a></li>
    </ul>
  </li>
    ...
    <div class="bs-docs-section span9  borderC" > 
      <!--Body content-->
   ...
   <div class="row">
      <div class="span7">
         <div id="header-container">
            ...
            <div class="dropdown">
               <h1 class="header-dropdown accent-color  text-info">&nbsp;&nbsp;แก้ไขข้อมูลสถานฝึกงาน</h1>
            </div>
         </div>
      </div>
   </div>
      ...
      <form id="frmeditcompany" action="editcompany.php" method="post" enctype="multipart/form-data" >
        <table  class="table table-hover">
          <tbody>
            <tr>
              <td ><label class="control-label text-success" for="inputIcon"><span class="add-on"><i class="icon-library"></i></span> รหัสสถานฝึกงาน</label>
                <input type="text" name="txtCompany" placeholder="CompanyID"  disabled="disabled" ></td>
              <td ></td>
              </tr>
            <tr>
              <td colspan="2"><label class="control-label text-success" >ชื่อสถานฝึกงาน</label>
                <input name="txtCompanyName" type="text"   placeholder="CompanyName"  class="input-xlarge validate[required]"></td>
           
            </tr>
            
            <tr>
              <td colspan="2" ><label class="control-label text-success">ที่อยู่สถานฝึกงาน</label>
              <textarea name="CompanyAddress" rows="5"   class="validate[required]" style="width:400px;"></textarea></td>
          </tr>
            
                        <th colspan="2">ประเภทธุรกิจ</th>
                  <tr>
                    <td colspan="2"><select data-placeholder="เลือกประเภทธุรกิจ..." name="JobType" id="JobType" class="validate[required]" >
...
<!-- loopj-jquery-simple-slider ตัวเลื่อนคะแนนแต่ละปัจจัย--> 
<script>
		  $("[data-slider]")
			.each(function () {
			  var input = $(this);
