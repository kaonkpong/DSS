$( function() {
    ...
    var trafficSound = new buzz.sound( '' ),
        clickSound = new buzz.sound( './FullscreenSlideshowAudio/sounds/click' ),
        focusSound = new buzz.sound( './/sounds/focus' ),
        rewindSound = new buzz.sound( './FullscreenSlideshowAudio/sounds/rewind' ),
