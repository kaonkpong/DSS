...
<body>
    <h2>Member Manage Application</h2>
    <div class="demo-info" style="margin-bottom:10px">
        <div class="demo-tip icon-tip">&nbsp;</div>
        <div>จัดการข้อมูลสมาชิก/นักศึกษา</div>
    </div>
    ...
    <table id="dg" title="My Users" class="easyui-datagrid" style="width:700px;height:300px"
        ...
        <thead>
            <tr>
                <th field="id" width="50">รหัสสมาชิก</th>
                <th field="firstname" width="50">ชื่อ</th>
                <th field="lastname" width="50">นามสกุล</th>
                <th field="email" width="50">Email</th>
                <th field="class" width="50">สาขา/ชั้นปี</th>
            </tr>
        </thead>
    </table>
    <div id="toolbar">
